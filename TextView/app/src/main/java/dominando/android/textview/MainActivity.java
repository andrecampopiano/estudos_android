    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Html.ImageGetter imgGetter = new Html.ImageGetter() {
            ...
            public Drawable getDrawable(String source) {
                ...
                try{
                    Bitmap bmp = BitmapFactory.decodeStream(getAssets().open(source));
